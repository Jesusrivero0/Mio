...
public class Sociedad {
	...
	public void borrarGenero(String g) throws ParametroIncorrectoException {
		for (Persona persona : conjunto) {
			if(!persona.getGenero().equalsIgnoreCase(g)) {
